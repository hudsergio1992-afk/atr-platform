...
/**
 * Как прораб отмечает выполнение этапа.
 * volume — набранным натуральным объёмом (м³ бетона, т металла, шт свай).
 * percent — процентом готовности: силос один, а собирается месяц, и отмечать
 * его долю в штуках бессмысленно.
 */
